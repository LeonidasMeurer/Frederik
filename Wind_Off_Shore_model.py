...
if os.path.exists("DataFrames/Off_Shore/Wind_Off_Shore_2018_2022_quaterhour.csv"):
    
    hourly_dataframe = pd.read_csv("DataFrames/Off_Shore/Wind_Off_Shore_2018_2022_quaterhour.csv")
    ...
    print(hourly_dataframe)
    hourly_dataframe.to_csv("DataFrames/Off_Shore/Wind_Off_Shore_2018_2022_3Std_15Data.csv")

    # Add Colum from Off_Shore Power
    hourly_dataframe['Off_Shore'] = pd.read_csv("Power_Data\Wind_Off_Shore_2018_2022.csv")
    hourly_dataframe.to_csv("DataFrames/Off_Shore/Wind_Off_Shore_2018_2022_3Std_&_Wetter_15Data.csv")
...
model_name = 'autoF_2018_2022_3Stand_14Data'

tuner = kt.Hyperband(model_builder,
                     objective="val_mse",
                     max_epochs=10,
                     factor=3,
                     directory='hyper_var_fitting/Off_Shore',
...
if os.path.exists("models/Off_Shore/" + model_name):
    model = load_model("models/Off_Shore/" + model_name)
    
else:
    cp = ModelCheckpoint("models/Off_Shore/" + model_name, save_best_only=True)
...
# 3 Layer 3 Standorte 5 Jahre models\autoF_2018_2022_3Stand
# MSE:  767.761667925534

# 3 Layer 3 Standorte 5 Jahre 14 Datenpunkte
# MSE:  761.8900104809077
...
if os.path.exists("DataFrames/Off_Shore/Wind_Off_Shore_2023_bis_Nov.csv"):
    
    dataframe_2023 = pd.read_csv("DataFrames/Off_Shore/Wind_Off_Shore_2023_bis_Nov.csv")
    ...
    dataframe_2023.to_csv("DataFrames/Off_Shore/Wind_Off_Shore_2023_bis_Nov.csv")
        

print(dataframe_2023)
dataframe_2023_preprocessed = preproccesor(dataframe_2023)

pred_2023 = model.predict(dataframe_2023_preprocessed)
off_shore_2023 = pd.read_csv("Power_Data/Off_Shore_2023_bis_Nov.csv")
