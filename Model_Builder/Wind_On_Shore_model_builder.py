...
if os.path.exists("DataFrames/On_Shore/Wind_On_Shore_&_Wetter.csv"):
    
    hourly_dataframe = pd.read_csv("DataFrames/On_Shore/Wind_On_Shore_&_Wetter.csv")
    ...
    print(hourly_dataframe)
    hourly_dataframe.to_csv("DataFrames/On_Shore/Wind_On_Shore_2015_2022.csv")

    # Add Colum from On_Shore Power
    hourly_dataframe['On_Shore'] = pd.read_csv("Power_Data/Wind_On_Shore_2015_2022.csv")
    hourly_dataframe.to_csv("DataFrames/On_Shore/Wind_On_Shore_&_Wetter.csv")
...
if os.path.exists("DataFrames/On_Shore/Wind_On_Shore_2023.csv"):
    
    dataframe_2023 = pd.read_csv("DataFrames/On_Shore/Wind_On_Shore_2023.csv")
    ...
    dataframe_2023.to_csv("DataFrames/On_Shore/Wind_On_Shore_2023.csv")
...
on_shore_2023 = pd.read_csv("Power_Data/Wind_On_Shore_2023.csv")
