...
if os.path.exists("DataFrames/Photovoltaik/Photovoltaik_&_Wetter.csv"):
    
    hourly_dataframe = pd.read_csv("DataFrames/Photovoltaik/Photovoltaik_&_Wetter.csv")
    ...
    hourly_dataframe.to_csv("DataFrames/Photovoltaik/Photovoltaik_2015_2022.csv")

    # Add Colum from Photovoltaik Power
    hourly_dataframe['Photovoltaik'] = pd.read_csv("Power_Data/Photovoltaik_2015_2022.csv")
    hourly_dataframe.to_csv("DataFrames/Photovoltaik/Photovoltaik_&_Wetter.csv")
...
if os.path.exists("DataFrames/Photovoltaik/Photovoltaik_2023.csv"):
    
    dataframe_2023 = pd.read_csv("DataFrames/Photovoltaik/Photovoltaik_2023.csv")
    ...
    dataframe_2023.to_csv("DataFrames/Photovoltaik/Photovoltaik_2023.csv")
...
off_shore_2023 = pd.read_csv("Power_Data/Photovoltaik_2023.csv")
